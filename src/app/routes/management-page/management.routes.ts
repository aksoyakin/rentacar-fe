...
import { ManagementCreateBrandPageComponent } from "./management-brands-page/management-create-brand-page.component";
import { ManagementEditBrandPageComponent } from "./management-brands-page/management-edit-brand-page.component";
import { ManagementPageComponent } from "./management-page.component";
import { ManagementModelsPageComponent } from "./management-models-page/management-models-page.component";
import { ManagementCreateModelPageComponent } from "./management-models-page/management-create-model-page.component";
import { ManagementEditModelPageComponent } from "./management-models-page/management-edit-model-page.component";
import { ManagementCarsPageComponent } from "./management-cars-page/management-cars-page.component";
import { ManagementCreateCarPageComponent } from "./management-cars-page/management-create-car-page.component";
import { ManagementEditCarPageComponent } from "./management-cars-page/management-edit-car-page.component";
...
export const managementRoutes: Routes = [
    {
      ...
      children: [
        ...
        {
          path: 'cars/edit/:carId', //dinamik olarak id gelecek demek ":"
